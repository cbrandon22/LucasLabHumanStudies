...
% Bandpass filter LFP signal 150-200Hz
        ...
        fs = 1000;
        ripple_duration = [0.02 0.15]; %ripple duration/width = 0.02 - 0.15 seconds or 20-150ms.
...
% RMS signal (see threshold and noise levels below).
        ...
        threshold = signalmean.*thresh; % defines the threshold
        noise = signalmean.*noise1; % defines noise level
