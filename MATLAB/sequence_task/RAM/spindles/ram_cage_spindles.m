...
%         end
          ...
          save([ddir subj filesep 'processed' filesep tank '_vt2'],'dat','EEGWave','EEGFreqs','EEGData2','t','N','S','fs','detection','begins','ends');
    end
