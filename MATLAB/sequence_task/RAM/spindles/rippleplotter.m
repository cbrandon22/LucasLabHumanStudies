...
win1 = 500;
win2 = 500;
Volts1 = dat(ripples_start_end(Spind,1)-win1:ripples_start_end(Spind,2)+win2);
...
Time2 = 0-win1:ripples_start_end(Spind,2)+win2-ripples_start_end(Spind,1);
% Time3 = Time1-spindles_start_end(Spind,2)+win2;
figure('Name',['EEG Ripple (D040615)'])
