function spindleplotterFidel
% [spindles_start_end, detected_spindles, coefs] = spindle_estimation_FHN2015(dat(3600*1000:2*3600*1000), 1000);

fs = 1000;
ich = 5; %channel (fidel's 6 channel data, 3&4 = L CA3, 2&3 = L amydala; 6&7 = L DG
Spind = 1;
win1 = 500;
win2 = 500;
Volts1 = dat(spindles_start_end(Spind,1)-win1:spindles_start_end(Spind,2)+win2, ich);
