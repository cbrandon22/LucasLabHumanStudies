function [Nf,scales,CMD,PD,iccc,irp,icc,eye0,eye1,eyeX,eyeY] = ccdtCorrPrepTEST
...
pdir = [ddir subj '/temp/processed/ccdtCorr/']; % prepared data directory
...
fseek(fid,40,'bof');
eye0 = fread(fid,inf,'single')/1e6; % eye X (pixels)
fclose(fid);
