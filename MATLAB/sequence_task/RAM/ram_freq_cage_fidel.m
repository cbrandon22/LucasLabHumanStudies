...
dday = [100515 100815 101415 111715];
srates =[1000 1000 1000 1000];
chns = [1 1 1 6];
subj = 'fidel';

for j=1:length(dday);

    tank = ['fidel_cage_' num2str(dday(j))]; % tank 
...
% data
    ...
    % smoothing
            ...
            % save
            save([ddir subj filesep 'processed' filesep tank],'PM','x','freq','DAT');
        end
