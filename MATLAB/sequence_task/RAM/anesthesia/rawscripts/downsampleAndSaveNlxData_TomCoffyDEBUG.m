function downsampleAndSaveNlxData_TomCoffyDEBUG(subj,rawDataPath)
%
% FUNCTION:
%  downsampleAndSaveNlxData.m
%
% DESCRIPTION:
%
% INPUTS:
...
% initialize
nlx_downsample_config_file % yields downsampleStruct
...
% define globals fr use in this function
clear global
...
for k=1:length(elecNames)
  ...
  chanfileName = sprintf('%s.%03i', fileExt,k);
  ...
  writeJackksheetLine_local(fid,k,elecNames{k});
