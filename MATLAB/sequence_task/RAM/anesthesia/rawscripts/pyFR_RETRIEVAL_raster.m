function pyFR_RETRIEVAL_raster(subj,rawDataPath,behDataPath,channelStr)
...
wordEv  = ev(strcmp({ev.type},'REC_WORD'));
recEv   = wordEv([wordEv.intrusion]==0);
notEv   = wordEv([wordEv.intrusion]~=0);
