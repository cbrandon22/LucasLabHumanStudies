...
subj = 'HUP121_i'; % subject
subjF = 'HUP121_i_01Jul16_0822'; % raw data name?
save_dir = [top_dir, subj, '/processed_data/dci'];
notes_dir = [top_dir, subj,  '/docs/'];
data_dir = [top_dir, subj, '/raw/2016-07-01_08-19-29'];

% about elecs
[~, labels, ~] = xlsread([notes_dir, 'electrodeMap(missing1).xlsx']); % not sure how cell naming scheme works, so read in everything then select what you want
% now taking depths
elecs = 1:115;
...
elec_info.all = elecs;
elec_info.bad = sort([1 17 38 41 89 97:115]);
