...
% events
load([top_dir, subj, '/behavioral/session_0/events.mat'],'events'); % get behavioral data
...
nl_dur = ((10*60*60) + (26*60) + 54) - ((9*60*60) + (56*60) + 35);
% srate = total samples/ total seconds
nl_srate = (NEV(end).lfpoffsetNEV)/nl_dur;
...
ana_start = 810058533/nl_srate; % HUP119
...
% add artifact time, and take it out
parameters.artifact = [2693120:2766848];
...
elec_info.all = elecs;
elec_info.bad = sort([1 2 16 25 32 48 49 56 89 90 110 122]);
