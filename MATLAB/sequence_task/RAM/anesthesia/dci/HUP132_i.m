...
subj = 'HUP132_i'; % subject
subjF = 'HUP132_i_08Jun16_1708'; % raw data name?
save_dir = [top_dir, subj, '/processed_data/dci'];
notes_dir = [top_dir, subj,  '/docs/'];
data_dir = [top_dir, subj, '/raw/2017-01-27_07-04-20'];
...
% Couldn't get this too work, not using it currently
