...
subj = 'HUP125_i'; % subject
subjF = 'HUP125_i_01Jul16_0822'; % raw data name?
save_dir = [top_dir, subj, '/processed_data/dci'];
notes_dir = [top_dir, subj,  '/docs/'];
data_dir = [top_dir, subj, '/raw/2016-09-21_09-28-15'];
...
elec_info.all = elecs;
elec_info.bad = sort([1 4 8 9 120:128 46 56 72 107 113]);
