...
subj = 'HUP060_i'; % subject
subjF = 'HUP060_i_06May16_0754'; % raw data name?
save_dir = [top_dir, subj, '/processed_data/dci'];
notes_dir = [top_dir, subj,  '/docs/'];
data_dir = [top_dir, subj, '/raw/2016-05-06_07-19-48'];
...
coc = floor(coc + (45939498/nl_srate))*srate; % HUP 60
...
elec_info.all = elecs;
elec_info.bad = sort([1 2 4 14 25 27 17]);
