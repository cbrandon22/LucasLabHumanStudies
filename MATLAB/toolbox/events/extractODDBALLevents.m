function extractODDBALLevents(subject,expDir,session,forceSession)
%
% FUNCTION:
...
%   (2) Oddball version by cbrandon on 6/20/2017 (cbrandon22@gmail.com)
...
% print opening line
fprintf('  Making ODDBALL EVENTS for ')
fprintf('%s, session %d: \n',subject,session)
