...
function [plv] = PLV(eegData, srate, filtSpec, dataSelectArr)
...
%   [plv] = PLV(eegData, srate, filtSpec, dataSelectArr);
...
% eegData = permute(eegData,[2 3 1]);
% [b,a] = butter(2,filtSpec.range/(srate/2)); % where srate is samples/second
