function [meddev,rawDevs,b]=logalign(beh_ms,eeg_offset,eeg_files,log_files,ms_field)
...
%        events(l);
    ...
    if dostruct
      ...
      %%% IMP 9/14/15 : REMOVES /mnt FROM THE FILE NAME
      events(l).eegfile = regexprep(fileroot{ef}, '/mnt', '');
