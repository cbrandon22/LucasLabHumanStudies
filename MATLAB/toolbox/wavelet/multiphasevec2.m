...
function [phase,pow,Sfft]=multiphasevec2(f,S,Fs,width,Sfft)
...
%
%7/16/10  jrm  return Sfft (discrete fourier transform) of signal and
%allow it to be passed on as an optional argument.
