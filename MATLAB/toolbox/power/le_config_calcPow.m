...
if ~exist('task','var') || isempty(task)
    ...
    switch task
        ...
        case('CCDT')
           outStruct.freQ =  logspace(log10(1), log10(100),50);
           outStruct.freqBins = logspace(log10(1), log10(100),50);%[4 8 16 30 50 95];  
           outStruct.freqBinLbl={round((logspace(log10(1), log10(100),50)))};
